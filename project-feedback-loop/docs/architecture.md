...
For a team-level view, several registries can be refreshed and aggregated into
a portfolio projection. The workspace origin remains attached to every item,
